...
--          each role can do when accessing group19GA through phpMyAdmin
--          or the REST API.
--
-- ROLE ARCHITECTURE:
...
GRANT EXECUTE
    ON FUNCTION group19GA.fn_days_open
    TO 'jhb_api_user'@'localhost';

GRANT EXECUTE
    ON FUNCTION group19GA.fn_calculate_sla_breach
    TO 'jhb_api_user'@'localhost';

GRANT EXECUTE
    ON FUNCTION group19GA.fn_get_priority_score
    TO 'jhb_api_user'@'localhost';

GRANT EXECUTE
    ON FUNCTION group19GA.fn_compute_sla_deadline
    TO 'jhb_api_user'@'localhost';

GRANT EXECUTE
    ON FUNCTION group19GA.fn_generate_reference
    TO 'jhb_api_user'@'localhost';


-- -----------------------------------------------------------------------------
-- 3.2 DBA — all privileges on group19GA, with GRANT OPTION
...
GRANT SELECT ON group19GA.districts          TO 'jhb_analyst'@'%';
GRANT SELECT ON group19GA.asset_types        TO 'jhb_analyst'@'%';
GRANT SELECT ON group19GA.assets             TO 'jhb_analyst'@'%';
GRANT SELECT ON group19GA.maintenance_requests TO 'jhb_analyst'@'%';
GRANT SELECT ON group19GA.work_orders        TO 'jhb_analyst'@'%';
GRANT SELECT ON group19GA.work_order_assignments TO 'jhb_analyst'@'%';
GRANT SELECT ON group19GA.parts_inventory    TO 'jhb_analyst'@'%';
GRANT SELECT ON group19GA.parts_usage        TO 'jhb_analyst'@'%';
GRANT SELECT ON .inspections        TO 'jhb_analyst'@'%';
...
GRANT SELECT ON group19GA.v_open_requests             TO 'jhb_analyst'@'%';
GRANT SELECT ON group19GA.v_sla_breached_orders       TO 'jhb_analyst'@'%';
GRANT SELECT ON group19GA.v_low_stock_alerts          TO 'jhb_analyst'@'%';
GRANT SELECT ON group19GA.v_asset_condition_by_district TO 'jhb_analyst'@'%';
GRANT SELECT ON group19GA.v_request_audit_trail       TO 'jhb_analyst'@'%';

-- Analyst can call reporting functions
GRANT EXECUTE ON FUNCTION group19GA.fn_days_open            TO 'jhb_analyst'@'%';
GRANT EXECUTE ON FUNCTION group19GA.fn_get_priority_score   TO 'jhb_analyst'@'%';
GRANT EXECUTE ON FUNCTION group19GA.fn_calculate_sla_breach TO 'jhb_analyst'@'%';

-- Analyst can call the district report procedure (read-only cursor procedure)
GRANT EXECUTE ON PROCEDURE group19GA.sp_generate_district_report TO 'jhb_analyst'@'%';
...
-- -----------------------------------------------------------------------------
GRANT SELECT ON group19GA.*                  TO 'jhb_supervisor'@'%';

-- Supervisors call these procedures in daily operations
GRANT EXECUTE ON PROCEDURE group19GA.sp_submit_maintenance_request TO 'jhb_supervisor'@'%';
GRANT EXECUTE ON PROCEDURE group19GA.sp_assign_work_order          TO 'jhb_supervisor'@'%';
GRANT EXECUTE ON PROCEDURE group19GA.sp_close_work_order           TO 'jhb_supervisor'@'%';
GRANT EXECUTE ON PROCEDURE group19GA.sp_generate_district_report   TO 'jhb_supervisor'@'%';

-- Supervisors can use all scalar functions for their dashboards
GRANT EXECUTE ON FUNCTION group19GA.fn_days_open            TO 'jhb_supervisor'@'%';
GRANT EXECUTE ON FUNCTION group19GA.fn_calculate_sla_breach TO 'jhb_supervisor'@'%';
GRANT EXECUTE ON FUNCTION group19GA.fn_get_priority_score   TO 'jhb_supervisor'@'%';
GRANT EXECUTE ON FUNCTION group19GA.fn_compute_sla_deadline TO 'jhb_supervisor'@'%';
