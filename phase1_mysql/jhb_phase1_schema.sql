...
DROP DATABASE IF EXISTS group19GA;
CREATE DATABASE group19GA
...
('EMP-0001', 'Zeus',    'Chokoe',     'zeus.chokoe@jhbpw.gov.za',     '+27732137041', 'MANAGER',     'COM-ENG',   1, '2015-03-01'),
...
WHERE constraint_schema = 'group19GA'
ORDER BY table_name;
