...
--          each role can do when accessing group19 through phpMyAdmin
--          or the REST API.
--
-- ROLE ARCHITECTURE:
...
GRANT EXECUTE
    ON FUNCTION group19.fn_days_open
    TO 'jhb_api_user'@'localhost';

GRANT EXECUTE
    ON FUNCTION group19.fn_calculate_sla_breach
    TO 'jhb_api_user'@'localhost';

GRANT EXECUTE
    ON FUNCTION group19.fn_get_priority_score
    TO 'jhb_api_user'@'localhost';

GRANT EXECUTE
    ON FUNCTION group19.fn_compute_sla_deadline
    TO 'jhb_api_user'@'localhost';

GRANT EXECUTE
    ON FUNCTION group19.fn_generate_reference
    TO 'jhb_api_user'@'localhost';


-- -----------------------------------------------------------------------------
-- 3.2 DBA all privileges on group19, with GRANT OPTION
...
GRANT SELECT ON group19.districts          TO 'jhb_analyst'@'%';
GRANT SELECT ON group19.asset_types        TO 'jhb_analyst'@'%';
GRANT SELECT ON group19.assets             TO 'jhb_analyst'@'%';
GRANT SELECT ON group19.maintenance_requests TO 'jhb_analyst'@'%';
GRANT SELECT ON group19.work_orders        TO 'jhb_analyst'@'%';
GRANT SELECT ON group19.work_order_assignments TO 'jhb_analyst'@'%';
GRANT SELECT ON group19.parts_inventory    TO 'jhb_analyst'@'%';
GRANT SELECT ON group19.parts_usage        TO 'jhb_analyst'@'%';
GRANT SELECT ON group19.inspections        TO 'jhb_analyst'@'%';
...
GRANT SELECT ON group19.v_open_requests             TO 'jhb_analyst'@'%';
GRANT SELECT ON group19.v_sla_breached_orders       TO 'jhb_analyst'@'%';
GRANT SELECT ON group19.v_low_stock_alerts          TO 'jhb_analyst'@'%';
GRANT SELECT ON group19.v_asset_condition_by_district TO 'jhb_analyst'@'%';
GRANT SELECT ON group19.v_request_audit_trail       TO 'jhb_analyst'@'%';

-- Analyst can call reporting functions
GRANT EXECUTE ON FUNCTION group19.fn_days_open            TO 'jhb_analyst'@'%';
GRANT EXECUTE ON FUNCTION group19.fn_get_priority_score   TO 'jhb_analyst'@'%';
GRANT EXECUTE ON FUNCTION group19.fn_calculate_sla_breach TO 'jhb_analyst'@'%';

-- Analyst can call the district report procedure (read-only cursor procedure)
GRANT EXECUTE ON PROCEDURE group19.sp_generate_district_report TO 'jhb_analyst'@'%';
...
-- -----------------------------------------------------------------------------
GRANT SELECT ON group19.*                  TO 'jhb_supervisor'@'%';

-- Supervisors call these procedures in daily operations
GRANT EXECUTE ON PROCEDURE group19.sp_submit_maintenance_request TO 'jhb_supervisor'@'%';
GRANT EXECUTE ON PROCEDURE group19.sp_assign_work_order          TO 'jhb_supervisor'@'%';
GRANT EXECUTE ON PROCEDURE group19.sp_close_work_order           TO 'jhb_supervisor'@'%';
GRANT EXECUTE ON PROCEDURE group19.sp_generate_district_report   TO 'jhb_supervisor'@'%';

-- Supervisors can use all scalar functions for their dashboards
GRANT EXECUTE ON FUNCTION group19.fn_days_open            TO 'jhb_supervisor'@'%';
GRANT EXECUTE ON FUNCTION group19.fn_calculate_sla_breach TO 'jhb_supervisor'@'%';
GRANT EXECUTE ON FUNCTION group19.fn_get_priority_score   TO 'jhb_supervisor'@'%';
GRANT EXECUTE ON FUNCTION group19.fn_compute_sla_deadline TO 'jhb_supervisor'@'%';
